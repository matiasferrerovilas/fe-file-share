...
export const AVAILABLE_ICONS: AvailableIcon[] = [
  ...
  {
    name: "HomeOutlined",
    keywords: ["casa", "hogar", "home", "vivienda"],
    suggestedColor: "#faad14",
  },
  {
    name: "BulbOutlined",
    keywords: ["luz", "electricidad", "bombilla", "energia"],
    suggestedColor: "#fadb14",
  },
  { name: "FireOutlined", keywords: ["fuego", "gas", "calefaccion"], suggestedColor: "#fa541c" },
  {
    name: "ThunderboltOutlined",
    keywords: ["electricidad", "energia", "luz", "rayo"],
    suggestedColor: "#faad14",
  },
  {
    name: "ToolOutlined",
    keywords: ["herramienta", "reparacion", "servicio", "mantenimiento"],
    suggestedColor: "#1890ff",
  },
  {
    name: "ScissorOutlined",
    keywords: ["cortar", "peluqueria", "salon"],
    suggestedColor: "#eb2f96",
  },
  {
    name: "DashboardOutlined",
    keywords: ["panel", "tablero", "control"],
    suggestedColor: "#2f54eb",
  },

  // Alimentación
  {
    name: "ShoppingCartOutlined",
    keywords: ["supermercado", "compras", "mercado", "alimentos"],
    suggestedColor: "#52c41a",
  },
  {
    name: "CoffeeOutlined",
    keywords: ["cafe", "restaurante", "bebida", "comida"],
    suggestedColor: "#fa541c",
  },
  ...
  {
    name: "AppleOutlined",
    keywords: ["manzana", "fruta", "saludable", "comida"],
    suggestedColor: "#52c41a",
  },
  ...
  {
    name: "CarOutlined",
    keywords: ["auto", "coche", "vehiculo", "transporte"],
    suggestedColor: "#9254de",
  },
  {
    name: "RocketOutlined",
    keywords: ["cohete", "viaje", "rapido", "avion"],
    suggestedColor: "#fa8c16",
  },
  {
    name: "EnvironmentOutlined",
    keywords: ["ubicacion", "lugar", "mapa", "direccion"],
    suggestedColor: "#1890ff",
  },
  {
    name: "CompassOutlined",
    keywords: ["brujula", "navegacion", "direccion", "viaje"],
    suggestedColor: "#13c2c2",
  },

  // Entretenimiento
  {
    name: "VideoCameraOutlined",
    keywords: ["video", "streaming", "pelicula", "netflix"],
    suggestedColor: "#13c2c2",
  },
  {
    name: "PlayCircleOutlined",
    keywords: ["reproducir", "video", "multimedia"],
    suggestedColor: "#722ed1",
  },
  {
    name: "CustomerServiceOutlined",
    keywords: ["auriculares", "musica", "audio", "servicio"],
    suggestedColor: "#2f54eb",
  },
  { name: "SoundOutlined", keywords: ["sonido", "musica", "audio"], suggestedColor: "#722ed1" },
  {
    name: "TrophyOutlined",
    keywords: ["trofeo", "premio", "logro", "deporte"],
    suggestedColor: "#faad14",
  },
  {
    name: "CrownOutlined",
    keywords: ["corona", "premium", "vip", "especial"],
    suggestedColor: "#faad14",
  },
  ...
  {
    name: "LaptopOutlined",
    keywords: ["computadora", "laptop", "pc", "tecnologia"],
    suggestedColor: "#2f54eb",
  },
  ...
  {
    name: "CloudOutlined",
    keywords: ["nube", "almacenamiento", "cloud"],
    suggestedColor: "#13c2c2",
  },
  {
    name: "GlobalOutlined",
    keywords: ["global", "mundo", "internet", "web"],
    suggestedColor: "#2f54eb",
  },
  ...
  { name: "SkinOutlined", keywords: ["ropa", "vestimenta", "moda"], suggestedColor: "#722ed1" },
  {
    ...
    keywords: ["compras", "shopping", "bolsa"],
    suggestedColor: "#eb2f96",
  },
  {
    name: "HeartOutlined",
    keywords: ["corazon", "favorito", "me gusta"],
    suggestedColor: "#f5222d",
  },
  {
    name: "StarOutlined",
    keywords: ["estrella", "favorito", "destacado"],
    suggestedColor: "#faad14",
  },
  ...
  // Salud y bienestar
  {
    ...
    keywords: ["medicina", "salud", "farmacia", "hospital"],
    suggestedColor: "#f5222d",
  },
  {
    name: "ExperimentOutlined",
    keywords: ["laboratorio", "ciencia", "analisis"],
    suggestedColor: "#13c2c2",
  },
  ...
  {
    name: "BookOutlined",
    keywords: ["libro", "educacion", "estudio", "lectura"],
    suggestedColor: "#2f54eb",
  },
  ...
  {
    name: "IdcardOutlined",
    keywords: ["identificacion", "tarjeta", "id"],
    suggestedColor: "#13c2c2",
  },
  {
    name: "SafetyOutlined",
    keywords: ["seguridad", "proteccion", "seguro"],
    suggestedColor: "#52c41a",
  },
  {
    name: "FundOutlined",
    keywords: ["finanzas", "inversion", "crecimiento"],
    suggestedColor: "#52c41a",
  },
  ...
  // Otros
  {
    ...
    keywords: ["calendario", "fecha", "agenda"],
    suggestedColor: "#fa8c16",
  },
  { name: "ClockCircleOutlined", keywords: ["reloj", "tiempo", "hora"], suggestedColor: "#1890ff" },
  {
    name: "FieldTimeOutlined",
    keywords: ["tiempo", "reloj", "cronometro", "viaje"],
    suggestedColor: "#fa8c16",
  },
  {
    name: "SettingOutlined",
    keywords: ["configuracion", "ajustes", "opciones"],
    suggestedColor: "#8c8c8c",
  },
  {
    name: "FileTextOutlined",
    keywords: ["archivo", "documento", "texto"],
    suggestedColor: "#1890ff",
  },
  {
    name: "FolderOutlined",
    keywords: ["carpeta", "archivos", "documentos"],
    suggestedColor: "#faad14",
  },
